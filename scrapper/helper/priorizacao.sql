...
mongo 'ds059682.mongolab.com:59682/scrapstore' -u scrapstore -p scrapstore --eval "db.HOMELIST_COLLETION.find().forEach(function(doc){doc.last_scan_date = new ISODate('25-09-2015');db.HOMELIST_COLLETION.save(doc)});"
